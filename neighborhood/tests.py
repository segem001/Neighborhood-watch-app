...
class PostTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_user = User(username='segem', email='segem@gmail.com', password='1234')
        self.new_user.save()
        self.new_hood = Neighborhood(name="Westlands", location="Nairobi", occupants="333",health_contact="123", police_contact="444", hood_pic="me.png", admin=self.new_user)
        self.new_hood.save()
...
class BuninessTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_business=Business(bName="techs",user_id=4, hood_id=2, bEmail="segem@gmail.com")
